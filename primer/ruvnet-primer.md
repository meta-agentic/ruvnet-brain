...
<<<<<<< HEAD
`Brain version: v3.9.119-dev · Built: 2026-07-24 · Covers: 69/192 repos built @ pinned SHAs (see data/manifest.json)`
=======
`Brain version: v3.9.114-dev · Built: 2026-07-24 · Covers: 69/192 repos built @ pinned SHAs (see data/manifest.json)`
...
- A **portable brain** over **69 RuvNet building-block repos**, embedded and indexed (54 at pinned SHAs; concepts, ruv-gists, ruv-meetings are generated stores without a single source SHA).
...
- **metaharness** (formerly agent-harness-generator) — generate and evaluate agent harnesses.
...
3. **Pull in an uncovered repo on demand** (any of the 192 catalogued, or any rUv repo):
   ```
