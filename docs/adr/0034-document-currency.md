...
governs:
  ...
  - plugin/scripts/doc-currency-gate.sh
  - docs/adr/
  - docs/ddd/
...
**Decision date**: 2026-07-22 · **Last updated**: 2026-07-22 · **Why**: initial draft
**Implementation**: unbuilt · **Verified in sync**: never

This document proposes a schema and then wears it. Its own `impl: unbuilt` is derived, not modest:
`scripts/doc-currency.mjs` does not exist, and §6's gate would refuse any other value for it.
