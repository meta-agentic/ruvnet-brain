...
export function renderBlock(result, now) {
  const lines = [];
  lines.push(BEGIN);
  lines.push('<!-- Generated by scripts/lesson-promote.mjs. Edit freely — regeneration replaces only');
  lines.push('     this fenced block, and your edits to the rules themselves are preserved by review,');
  lines.push('     not overwritten silently: re-running reports a diff before --apply changes anything. -->');
  lines.push('');
