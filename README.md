...
### 🧠 RuvNet Brain — [![RuvNet Brain version 3.9.55-dev — updated 2026-07-23 04:06 EDT](https://img.shields.io/badge/version_3.9.55--dev-updated_2026--07--23_04:06_EDT-1E90FF?style=for-the-badge&labelColor=0757BA)](https://github.com/stuinfla/ruvnet-brain/blob/main/plugin/.claude-plugin/plugin.json)
...
- ✅ **The grounding brain is real and proven** — 54 public stores · 149,729 public source chunks (57 built stores incl. private), dual embeddings, cross-encoder rerank, plugin (MCP tool + enforcement hook + skill), all re-runnable.
