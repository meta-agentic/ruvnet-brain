...
### 🧠 RuvNet Brain — [![RuvNet Brain version 3.4.21-dev — updated 2026-07-20 03:20 EDT](https://img.shields.io/badge/version_3.4.21--dev-updated_2026--07--20_03:20_EDT-1E90FF?style=for-the-badge&labelColor=0757BA)](https://github.com/stuinfla/ruvnet-brain/blob/main/plugin/.claude-plugin/plugin.json)
...
- ✅ **The grounding brain is real and proven** — 54 public stores · 149,691 public source chunks (57 built stores incl. private), dual embeddings, cross-encoder rerank, plugin (MCP tool + enforcement hook + skill), all re-runnable.
