...
- ✅ **The grounding brain is real and proven** — 63 public stores · 152,598 public source chunks (70 built stores incl. private), dual embeddings, cross-encoder rerank, plugin (MCP tool + enforcement hook + skill), all re-runnable.
