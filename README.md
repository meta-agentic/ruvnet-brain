...
### 🧠 RuvNet Brain — [![RuvNet Brain version 3.4.0-dev — updated 2026-07-17 09:40 EDT](https://img.shields.io/badge/version_3.4.0--dev-updated_2026--07--17_09:40_EDT-1E90FF?style=for-the-badge&labelColor=0757BA)](https://github.com/stuinfla/ruvnet-brain/blob/main/plugin/.claude-plugin/plugin.json)
...
- ✅ **The grounding brain is real and proven** — 36 repos, 132,184 chunks, dual embeddings, cross-encoder rerank, plugin (MCP tool + enforcement hook + skill), all re-runnable.
